...
/****** Object:  Database [Bookish]    Script Date: 7/8/2025 3:40:37 PM ******/
CREATE DATABASE [Bookish]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Bookish', FILENAME = N'C:\Programs\MSSQL16.MSSQLSERVER\MSSQL\DATA\Bookish.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Bookish_log', FILENAME = N'C:\Programs\MSSQL16.MSSQLSERVER\MSSQL\DATA\Bookish_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [Bookish] SET QUERY_STORE = ON
GO

ALTER DATABASE [Bookish] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 1000, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
